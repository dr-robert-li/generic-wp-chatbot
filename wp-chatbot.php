 ...
 * WP Chatbot
 *
 * @package     Generic WP Chatbot
 * @author      Robert Li
 * @license     GPL-3.0
 *
 * @wordpress-plugin
 * Plugin Name: Generic WP Chatbot
 * Plugin URI: https://github.com/dr-robert-li/generic-wp-chatbot
 * Description: Simple, yet powerful plugin to include any chatbot on your site
 * Version: 0.1.2
 * Author: Kristoffer Lorentsen & Robert Li
 * Text Domain: generic-wp-chatbot
 * Domain Path: /languages
 * GitHub Plugin URI: https://github.com/dr-robert-li/generic-wp-chatbot
